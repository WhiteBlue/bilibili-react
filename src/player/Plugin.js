  ...
  load: function () {
    videojs.plugin('ABP', function () {
      function Danmu(ele) {
        ...
        this.danmuShowControlContent.className = 'am-icon-align-right';
        ...
        if (typeof CommentManager !== "undefined") {
          ...
          this.danmuShowControl.addEventListener("click", function () {
            if (_this.cmManager.display == true) {
              ...
              _this.cmManager.clear();
              _this.danmuShowControlContent.setAttribute("class", "am-icon-ban");
            } else {
              _this.cmManager.display = true;
              _this.danmuShowControlContent.setAttribute("class", "am-icon-align-right");
            }
          });
